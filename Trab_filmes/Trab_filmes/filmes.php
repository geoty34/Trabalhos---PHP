...
if (isset($_POST['submetido'])) {
    $sql= 'select * from filmes where nome = ?';
    $stmt = $conn->prepare($sql);
    $stmt->execute([$nome]);
    $filmesMesmoNome = $stmt->fetchAll();
    print_r($result);
...
<head>
    ...
    <title> Filmes - Geovana & Júlia beatriz</title>
        ...
        <div class="esquerda">
            <div class="form-container">
                ...
                <form action="" method="post" class="form">
                    ...
                    <input type="date" name="dt_lancamento" id="dtLanc" value="<?php echo "$dtLanc" ?>" />
                    ...
                    <div class="forgot">
                        <a rel="noopener noreferrer" href="#">Não lembra qual o filme ?</a>
                    </div>
                ...
                <p class="signup">Não tem conta?
                    <a rel="noopener noreferrer" href="#" style="color:aqua;"> Criar</a>
                </p>
